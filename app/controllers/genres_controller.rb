class GenresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @genre.save
        format.html { redirect_to edit_genre_url(@genre), notice: "Genre was successfully created." }
  ...
  def update
    respond_to do |format|
      if @genre.update(genre_params)
        format.html { redirect_to edit_genre_url(@genre), notice: "Genre was successfully updated." }
